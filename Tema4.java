...
public class tema4 {
    public static void main(String[] args) {
        ...
        if (numeroIf > 0) {
            ...
            System.out.println("a.El numero es negativo");
        }else {
            System.out.println("a.El numero es cero");
        }
        ...
        switch (estacion) {
            ...
            case "otoño":
                System.out.println("e. La estacion es otoño");
                break;
            case "invierno":
                System.out.println("e. La estacion es invierno");
                break;
            case "primavera":
                System.out.println("e. La estacion es primavera");
                break;
            case "verano":
                System.out.println("e. La estacion es verano");
                break;
            default: System.out.println("e. Debe ingresar una estacion");
